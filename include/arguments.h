...
void parse_args(int argc, char const *argv[]){
	...
	if(strcmp(argv[1],"-p")==0){
		...
		command_line_opts.nongenbin=cfg.getValueOfKey<int>("nongenbin",0); // Boyang added
		...
		if (i + 1 != argc){
			if(strcmp(argv[i],"-g")==0){
				...
				i++;
                                ...
                                command_line_opts.snp_index= atoi(argv[i+1]);
                                i++;
                        }
				...
				command_line_opts.missing=true;
                                ...
                                command_line_opts.fixed_eff=true;
				cout<<"ddddddddddddddddddddd"<<endl;
				cout<<command_line_opts.fixed_eff<<endl;
			}
